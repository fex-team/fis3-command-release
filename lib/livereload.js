      ...
      _.toArray(obj.modified).forEach(function(file) {
        ...
        content = content.replace(rLivereload, function(all, token) {
          if (token) {
            ...
            if (hostname) {
              all = '<script>window.WebSocket&&(function(d){var s=d.createElement(\'script\');s.src=\'//'+hostname+':'+port+'\/livereload.js\';d.head.appendChild(s)})(document);</script>';
              // all = '<script>window.WebSocket&&document.write(\'<script src="//'+hostname+':' + port + '\/livereload.js"><\\\/script>\');</script>';
            } else {
              all = '<script>window.WebSocket&&(function(d){var s=d.createElement(\'script\');s.src=\'//\'+location.hostname+\':'+port+'\/livereload.js\';d.head.appendChild(s)})(document);</script>';
              // all = '<script>window.WebSocket&&document.write(\'<script src="//\' + location.hostname + \':' + port + '\/livereload.js"><\\\/script>\');</script>';
            }
            all += token;
          }
